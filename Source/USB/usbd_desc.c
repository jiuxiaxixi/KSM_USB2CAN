...
#define USBD_PRODUCT_HS_STRING        "USB CDC in HS mode"
#define USBD_SERIALNUMBER_HS_STRING   "00000000011B"

#define USBD_PRODUCT_FS_STRING        "USB CDC in FS Mode"
...
#define USBD_LANGID_STRING            0x409
#define USBD_MANUFACTURER_STRING      "EmbedNet"

#define USBD_CONFIGURATION_HS_STRING  "USB CDC Config"
#define USBD_INTERFACE_HS_STRING      "USB CDC Interface"

#define USBD_CONFIGURATION_FS_STRING  "USB CDC Config"
#define USBD_INTERFACE_FS_STRING      "USB CDC Interface"
/**
  * @}
  */ 
...
{
	static uint8_t SerialStr[25]={0};
	sprintf((char*)SerialStr,"%04X%04X%04X",
		*(__IO uint32_t*)(0x1FFF7A10),
		*(__IO uint32_t*)(0x1FFF7A14),
		*(__IO uint32_t*)(0x1FFF7A18));
  if(speed  == USB_OTG_SPEED_HIGH)
  {    
    USBD_GetString (SerialStr, USBD_StrDesc, length);
  }
  else
  {
    USBD_GetString (SerialStr, USBD_StrDesc, length);    
